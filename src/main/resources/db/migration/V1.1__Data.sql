...
INSERT INTO question (id, description, title, user_id, status)
VALUES (1, 'Where can I find the credentials for courses and other resources for training',
        'Where are the credentials for online trainning?', 1, 'OPEN');

INSERT INTO question (id, description, title, user_id, status)
VALUES (2, 'Who is the person I should contact in case I require insurance health information',
        'What is the insurance health contact?', 1, 'OPEN');

INSERT INTO question (id, description, title, user_id, status)
VALUES (3, 'How can I watch the Friday Talk streaming', 'What is the info to connect to friday talks?', 1, 'OPEN');

INSERT INTO question (id, description, title, user_id, status)
VALUES (4, 'I want to take a PTO tomorrow but I do not know how is supposed to notify or how should I do this',
        'What is the procedure to ask for a PTO?', 1, 'OPEN');

INSERT INTO question (id, description, title, user_id, status)
VALUES (5, 'Where can I find the quality service document?', 'Where is quality service document?', 1, 'OPEN');

INSERT INTO question (id, description, title, user_id, status)
VALUES (6, 'I want to receive the prima payment on the day I will go on vacation',
        'What is the procedure to receive my prima vacacional?', 1, 'OPEN');

INSERT INTO question (id, description, title, user_id, status)
VALUES (7, 'I will take a workshop in Chicago next month. What should I do to request the travel procedure?',
        'What is the travel expense procedure?', 1, 'OPEN');

INSERT INTO question (id, description, title, user_id, status)
VALUES (8, 'DF office sponsored an event. We paid for pizzas and soda. What do I need to send you for reimbursement
            of the expense',
        'How can I request an invoice payment?', 1, 'OPEN');

INSERT INTO question (id, description, title, user_id, status)
VALUES (9, 'In my previous job I did need to do tax declaration. Why I need to do it here?',
        'Why do I need to do tax declaration?', 1, 'OPEN');

INSERT INTO question (id, description, title, user_id, status)
VALUES (10, 'I want to do my tax declaration online but I need my SAT password. How can I get it?',
        'How can I get my SAT password?', 1, 'OPEN');

-- Answers

INSERT INTO answer (id, description, question_id, user_id, status, votes_up, votes_down)
VALUES (1, 'https://docs.google.com/document/d/1JbMiYhO4W7eqolhdUqOAlRSgPEN3t7X3WsRweJOPE-w/edit#', 1, 1, 'OPEN',0 ,0);
...
5. Conference Call:  +52 554-160-7902 (Mexico) Access Code: 1171-6803', 3, 1, 'OPEN',0 ,0);

INSERT INTO answer (id, description, question_id, user_id, status, votes_up, votes_down)
VALUES (3, 'https://docs.google.com/document/d/1JbMiYhO4W7eqolhdUqOAlRSgPEN3t7X3WsRweJOPE-w/edit#', 4, 1, 'OPEN',0 ,0);
